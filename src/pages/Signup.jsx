      ...
      <div className="flex-grow flex items-center justify-center px-4">
        <div className="relative w-full max-w-[420px] p-8 bg-[#1e1e1e] rounded-[32px] border border-gray-800 shadow-2xl animate-in fade-in zoom-in duration-300">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              type="submit"
              className="w-full h-11 mt-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-2xl transition-all active:scale-[0.98] shadow-lg shadow-emerald-900/20 flex items-center justify-center gap-2"
            >
              Sign Up
