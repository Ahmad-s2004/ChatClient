...
const Account = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed md:absolute top-12 left-16 right-4 w-3/4 md:left-20 md:right-auto md:w-80 bg-[#1e1e1e] border border-gray-800 rounded-2xl shadow-2xl z-[100] overflow-hidden transition-all duration-300 ease-out animate-in fade-in slide-in-from-top-4 zoom-in-95">
      ...
      <div className="p-5 bg-[#252525] flex flex-col items-center border-b border-gray-800">
        <div className="relative group cursor-pointer">
          ...
          <div className="absolute bottom-0 right-0 bg-gray-900 p-1.5 rounded-full border border-gray-700 group-hover:bg-gray-800 transition-colors">
      ...
      <div className="p-2 max-h-[60vh] overflow-y-auto custom-scrollbar">
        <button className="w-full flex items-center justify-between p-3 hover:bg-gray-800 rounded-xl transition-all duration-200 group">
          ...
          <ChevronRight size={16} className="text-gray-600 group-hover:text-gray-400 transition-transform group-hover:translate-x-1" />
        </button>

        <button className="w-full flex items-center justify-between p-3 hover:bg-gray-800 rounded-xl transition-all duration-200 group">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-purple-500/10 rounded-lg text-purple-400 group-hover:bg-purple-400/20">
              <ShieldCheck size={18} />
            </div>
        ...
        <button className="w-full flex items-center justify-between p-3 hover:bg-gray-800 rounded-xl transition-all duration-200 group">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-orange-500/10 rounded-lg text-orange-400 group-hover:bg-orange-500/20">
